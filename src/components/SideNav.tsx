...
import { Home, ShoppingCart, CreditCard, History, User, Settings, HelpCircle, Bell, LogOut } from "lucide-react";
    ...
    <div className="h-full w-full bg-card border-r border-border overflow-auto">
      ...
      <div className="p-4">
        <div className="flex flex-col space-y-1">
          <NavItem icon={<Home />} label="Home" path="/" onClick={onItemClick} />
