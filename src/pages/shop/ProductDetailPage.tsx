...
const ProductDetailPage = () => {
  ...
  const [selectedEmiOption, setSelectedEmiOption] = useState<number | null>(null);
  ...
  const emiOptions = [
    ...
    { months: 6, interest: 0, monthlyAmount: Math.round(effectivePrice / 6) },
    { months: 12, interest: 9, monthlyAmount: Math.round((effectivePrice * 1.09) / 12) },
  ];
  ...
  const buyNow = () => {
    ...
    navigate("/checkout", { 
      state: { 
        ...
        emiOption: selectedEmiOption !== null ? emiOptions[selectedEmiOption] : null 
      }
    });
  };
    ...
    <Layout>
                ...
                <div className="space-y-3">
                  {emiOptions.map((option, index) => (
                    <div
                      ...
                      onClick={() => setSelectedEmiOption(index)}
                    >
                      <div className="flex justify-between">
                        <div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-background border-t border-border flex gap-3 md:px-6">
        ...
        >
          ...
          {selectedEmiOption !== null ? "Buy with EMI" : "Buy Now"}
        </Button>
      </div>
    </Layout>
  );
