      ...
      <div className="p-4 pb-20 md:p-6 space-y-6">
        ...
        <Card className="neon-glow">
          <CardContent className="p-6">
            <h2 className="text-lg font-medium mb-4">Your BNPL Credit</h2>
            
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-muted-foreground">Credit Limit Used</span>
                  <span>{formatCurrency(usedLimit)} / {formatCurrency(bnplLimit)}</span>
                </div>
                <Progress value={(usedLimit / bnplLimit) * 100} className="h-2" />
              </div>
              ...
              <div className="flex justify-between">
                ...
                <Link to="/shop">
                  <Button className="neon-glow mt-2">
                    Shop Now
